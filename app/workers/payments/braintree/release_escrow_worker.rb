  ...
  module Braintree
    class ReleaseEscrowWorker
      ...
      def init_log(payment_id)
        Rails.logger.info("Payments::Braintree::ReleaseEscrowWorker on payment_id: #{payment_id}")
      end
      ...
      def cant_release_log
        str = 'Payments::Braintree::ReleaseEscrowWorker invalid state on releasing'
