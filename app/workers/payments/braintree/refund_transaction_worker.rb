  ...
  module Braintree
    class RefundTransactionWorker
      ...
      def init_log(booking_id, user_id)
        str = "Payments::Braintree::RefundTransactionWorker on booking_id: #{booking_id}, "
        str += "user_id: #{user_id}"
        Rails.logger.info(str)
      end

      def not_refunded_log(booking_id, transaction)
        str = 'Payments::Braintree::RefundTransactionWorker not refunded on '
      ...
      def error_at_refund_log(booking_id, transaction_wrapper)
        str = 'Payments::Braintree::RefundTransactionWorker error at refund on '
        str += "booking_id: #{booking_id}, "
