  ...
  module Braintree
    class EscrowAcceptedWorker
      ...
      def not_accepted_payment_log(booking_id, transaction)
        str = 'Payments::Braintree::EscrowAcceptedWorker not_accepted_payment for '
        str += "booking_id: #{booking_id}, transaction_id: #{transaction.id}, "
        str += "transaction_status: #{transaction.status}"
