class BraintreeRefundTransactionJob
  ...
  class << self
    ...
    def init_log(booking_id, user_id)
      str = "BraintreeRefundTransactionJob on booking_id: #{booking_id}, user_id: #{user_id}"
      Rails.logger.info(str)
    end

    def not_refunded_log(booking_id, transaction)
      str = "BraintreeRefundTransactionJob not refunded on booking_id: #{booking_id}, "
    ...
    def error_at_refund_log(booking_id, transaction_wrapper)
      str = "BraintreeRefundTransactionJob error at refund on booking_id: #{booking_id}, "
