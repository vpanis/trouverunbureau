...
case Rails.env
  when 'development'
    ...
    # Users
    puts 'creating users'
    user1 = User.create!(first_name: "Robert", last_name: "De Niro", email: "robertdn@example.com", password: "12341234", phone: "23111131259", company_name: 'Wolox', interests: 'Lorem ipsum and stuff', profession: Venue::PROFESSIONS.first.to_s)
    user2 = User.create!(first_name: "Al", last_name: "Pacino", email: "apacino@example.com", password: "12341234", phone: "65468315358", company_name: 'Blue Jeans', interests: 'sarasa zaraza saraza zarasa', profession: Venue::PROFESSIONS.last.to_s)
    user3 = User.create!(first_name: "Judie", last_name: "Foster", email: "jfoster@example.com", password: "12341234", phone: "98461875135", company_name: 'i work solo', profession: Venue::PROFESSIONS.first.to_s)
    user4 = User.create!(first_name: "John", last_name: "Doe", email: "johndoe@example.com", password: "12341234", phone: "34155355515", company_name: 'freelancer', profession: Venue::PROFESSIONS.first.to_s)
    user5 = User.create!(first_name: "Danny", last_name: "Devito", email: "dannyd@example.com", password: "12341234", phone: "87964522466", company_name: 'We are the best', profession: Venue::PROFESSIONS.last.to_s)
    user6 = User.create!(first_name: "Julia", last_name: "Robert", email: "juliar@example.com", password: "12341234", phone: "65735238463", company_name: 'Wololo', profession: Venue::PROFESSIONS.first.to_s)
    user7 = User.create!(first_name: "Sean", last_name: "Connery", email: "sconnery@example.com", password: "12341234", phone: "98976865432", company_name: 'Ultimate devs', profession: Venue::PROFESSIONS.last.to_s)
    user8 = User.create!(first_name: "Angelina", last_name: "Jolie", email: "ajolie@example.com", password: "12341234", phone: "65468363365", company_name: 'Best Designers', profession: Venue::PROFESSIONS.last.to_s)
    user9 = User.create!(first_name: "Carlin", last_name: "Calvo", email: "el_hacker@example.com", password: "12341234", phone: "26654561666", company_name: 'Molox', profession: Venue::PROFESSIONS.last.to_s)
    user10 = User.create!(first_name: "Quentin", last_name: "Tarantino", email: "qtarantino@example.com", password: "12341234", phone: "6446468684", company_name: 'XO7OM', profession: Venue::PROFESSIONS.last.to_s)
    ...
    venue1 = Venue.create!(owner: org1, town: "Buenos Aires", street: "Ayacucho", postal_code: "6541", country: 'Argentina', phone: "68731388", email: "the_place_ayacucho@example.com", website: "www.theplaceayacucho.com", latitude: -30, longitude: -40, name: "The Place Ayacucho", description: Faker::Lorem.paragraph(20), currency: "ars", v_type: Venue.v_types[:corporate_office], space: 400, space_unit: Venue.space_units[:square_mts], floors: 2, rooms: 7, desks: 14, vat_tax_rate: 0, amenities: ["wifi", "cafe_restaurant", "cafe_restaurant"])
    ...
    venue2 = Venue.create!(owner: org2, town: "Buenos Aires", street: "Rivadavia", postal_code: "3121", country: 'Argentina', phone: "571687666", email: "the_best_place1@example.com", website: "www.thebestplace.com/buenosaires", latitude: -30.002, longitude: -40, name: "The Best Place Buenos Aires", description: Faker::Lorem.paragraph(20), currency: "ars", v_type: Venue.v_types[:business_center], space: 300, space_unit: Venue.space_units[:square_mts], floors: 2, rooms: 4, desks: 14, vat_tax_rate: 0.1, amenities: ["wifi", "cafe_restaurant", "cafe_restaurant", "mail_service", "wheelchair_access"])
    ...
    venue3 = Venue.create!(owner: org2, town: "Madrid", street: "Malasaña", postal_code: "6511", country: 'España', phone: "66876064", email: "the_best_place2@example.com", website: "www.thebestplace.com/madrid", latitude: 30, longitude: 90, name: "The Best Place Madrid", description: Faker::Lorem.paragraph(20), currency: "euro", v_type: Venue.v_types[:design_studio], space: 800, space_unit: Venue.space_units[:square_mts], floors: 3, rooms: 10, desks: 30, vat_tax_rate: 0.2, amenities: ["wifi", "cafe_restaurant", "cafe_restaurant", "mail_service", "wheelchair_access"])
    v3_sp1 = Space.create!(venue: venue3, s_type: Space.s_types[:desk], name: "Desk", capacity: 1, quantity: 25, hour_price: 10, day_price: 25, month_price: 450, description: Faker::Lorem.paragraph(10))
    ...
    venue4 = Venue.create!(owner: org3, town: "Berlin", street: "Bla strasse", postal_code: "5155", country: 'Germany', phone: "89040648", email: "desklirium@example.com", website: "www.desklirium.com", latitude: 0, longitude: 40, name: "Desklirium", description: Faker::Lorem.paragraph(20), currency: "euro", v_type: Venue.v_types[:design_studio], space: 200, space_unit: Venue.space_units[:square_mts], floors: 1, rooms: 3, desks: 20, vat_tax_rate: 0.1, amenities: ["wifi", "cafe_restaurant"])
    ...
    venue6 = Venue.create!(owner: user7, town: "Dublin", street: "Temple str", postal_code: "6166", country: 'Ireland', phone: "516166646", email: "the_other_desk@example.com", website: "www.otherdesk.com", latitude: -30, longitude: 0, name: "The Other Desk", description: Faker::Lorem.paragraph(20), currency: "euro", v_type: Venue.v_types[:startup_office], space: 100, space_unit: Venue.space_units[:square_mts], floors: 1, rooms: 2, desks: 4, vat_tax_rate: 0, amenities: ["wifi", "pets_allowed", "kitchen", "fax"])
