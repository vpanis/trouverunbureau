...
VenueHour.create(venue: venue1, weekday: 0, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue1, weekday: 1, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue1, weekday: 2, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue1, weekday: 3, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue1, weekday: 4, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))

venue2 = Venue.create(owner: org2, town: "Buenos Aires", street: "Rivadavia", postal_code: "3121", phone: "571687666", email: "the_best_place1@example.com", website: "www.thebestplace.com/buenosaires", latitude: -30.002, longitude: -40, name: "The Best Place Buenos Aires", description: Faker::Lorem.paragraph(20), currency: "ars", v_type: Venue.v_types[:business_center], space: 300, space_unit: Venue.space_units[:square_mts], floors: 2, rooms: 4, desks: 14, vat_tax_rate: 0.1, amenities: ["wifi", "catering_available", "cafe_restaurant", "mail_service", "wheelchair_accessible"])
...
VenueHour.create(venue: venue2, weekday: 0, from: beginning_of_day.advance(hours: 7), to: beginning_of_day.advance(hours: 21))
VenueHour.create(venue: venue2, weekday: 1, from: beginning_of_day.advance(hours: 7), to: beginning_of_day.advance(hours: 21))
VenueHour.create(venue: venue2, weekday: 2, from: beginning_of_day.advance(hours: 7), to: beginning_of_day.advance(hours: 21))
VenueHour.create(venue: venue2, weekday: 3, from: beginning_of_day.advance(hours: 7), to: beginning_of_day.advance(hours: 21))
VenueHour.create(venue: venue2, weekday: 4, from: beginning_of_day.advance(hours: 7), to: beginning_of_day.advance(hours: 21))
VenueHour.create(venue: venue2, weekday: 5, from: beginning_of_day.advance(hours: 10), to: beginning_of_day.advance(hours: 18))

venue3 = Venue.create(owner: org2, town: "Madrid", street: "Malasaña", postal_code: "6511", phone: "66876064", email: "the_best_place2@example.com", website: "www.thebestplace.com/madrid", latitude: 30, longitude: 90, name: "The Best Place Madrid", description: Faker::Lorem.paragraph(20), currency: "euro", v_type: Venue.v_types[:studio], space: 800, space_unit: Venue.space_units[:square_mts], floors: 3, rooms: 10, desks: 30, vat_tax_rate: 0.2, amenities: ["wifi", "catering_available", "cafe_restaurant", "mail_service", "wheelchair_accessible"])
...
VenueHour.create(venue: venue3, weekday: 0, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 22))
VenueHour.create(venue: venue3, weekday: 1, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 22))
VenueHour.create(venue: venue3, weekday: 3, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 22))
VenueHour.create(venue: venue3, weekday: 4, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 22))

venue4 = Venue.create(owner: org3, town: "Berlin", street: "Bla strasse", postal_code: "5155", phone: "89040648", email: "desklirium@example.com", website: "www.desklirium.com", latitude: 0, longitude: 40, name: "Desklirium", description: Faker::Lorem.paragraph(20), currency: "euro", v_type: Venue.v_types[:studio], space: 200, space_unit: Venue.space_units[:square_mts], floors: 1, rooms: 3, desks: 20, vat_tax_rate: 0.1, amenities: ["wifi", "catering_available", "cafe_restaurant"])
...
VenueHour.create(venue: venue4, weekday: 0, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue4, weekday: 1, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue4, weekday: 2, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue4, weekday: 3, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue4, weekday: 4, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue4, weekday: 5, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue4, weekday: 6, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
...
VenueHour.create(venue: venue5, weekday: 0, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 19))
VenueHour.create(venue: venue5, weekday: 1, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue5, weekday: 2, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 21))
VenueHour.create(venue: venue5, weekday: 3, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 20))
VenueHour.create(venue: venue5, weekday: 4, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 19))
...
VenueHour.create(venue: venue6, weekday: 0, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 12))
VenueHour.create(venue: venue6, weekday: 0, from: beginning_of_day.advance(hours: 14), to: beginning_of_day.advance(hours: 24))
VenueHour.create(venue: venue6, weekday: 1, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 12))
VenueHour.create(venue: venue6, weekday: 1, from: beginning_of_day.advance(hours: 14), to: beginning_of_day.advance(hours: 24))
VenueHour.create(venue: venue6, weekday: 2, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 12))
VenueHour.create(venue: venue6, weekday: 2, from: beginning_of_day.advance(hours: 14), to: beginning_of_day.advance(hours: 24))
VenueHour.create(venue: venue6, weekday: 3, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 12))
VenueHour.create(venue: venue6, weekday: 3, from: beginning_of_day.advance(hours: 14), to: beginning_of_day.advance(hours: 24))
VenueHour.create(venue: venue6, weekday: 4, from: beginning_of_day.advance(hours: 8), to: beginning_of_day.advance(hours: 12))
VenueHour.create(venue: venue6, weekday: 4, from: beginning_of_day.advance(hours: 14), to: beginning_of_day.advance(hours: 24))
